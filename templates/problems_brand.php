...
if (mysqli_num_rows($sql) != false) {
      ...
      <a class="t-3" title="Редактировать карточку" href="/edit-problem-brand/'.$_GET['id'].'/'.$row['id'].'/" ></a>
      </td></tr>';
      }
      }   */
...
<head>
<meta charset=utf-8>
<title>Проделанная работа (бренд) - Панель управления</title>
...
<?=menu_dash();?>
           ...
           <br>
           <h2>Проделанная работа (бренд)</h2>
