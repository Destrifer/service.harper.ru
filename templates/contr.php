...
if (mysqli_num_rows($sql) != false) {
      ...
      <a class="t-3" title="Редактировать карточку" href="/edit-contrahens/'.$row['id'].'/" ></a>
      <a class="t-5" title="Удалить карточку" onclick=\'return confirm("Вы уверены, что хотите удалить #'.$row['id'].'?")\'  style="float:right" href="/del-contrahens/'.$row['id'].'/"></a></td></tr>';
      }
      }
    return $content_list;
}
...
<?=menu_dash();?>
  ...
  <div class="adm-catalog">
       ...
       <div class="add">
      <a style="width: auto;padding-left: 7px;padding-right: 7px;" href="/add-contrahens/" class="button">Добавить контрагента</a>
    </div>
     <br>
  <table id="table_content" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th align="left">#</th>
                <th align="left">Название контрагента</th>
                <th align="left">Название руководящей должности</th>
