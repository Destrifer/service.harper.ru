...
function content_list() {
  global $db;
$content = array();
$sql = mysqli_query($db, 'SELECT * FROM `'.$_COOKIE['lang'].'configuration` WHERE `id` != 18;');
      while ($row = mysqli_fetch_array($sql)) {
...
<style>
.item-promo .jq-checkbox {
    width: 95% !important;
}
.adm-form .item-promo li .icon {
...
<?=menu_dash();?>
     ...
     <div class="wrapper">
 <font style="color:red;font-size:30px;">Все поломалось! ПОКА НЕ ПОЛЬЗУЙТЕСЬ ТУТ, слишком много изменений было от оригинальной админки, сложная интеграция будет</font>
      <br>
     <br><h1>Обработка документов:</h1>

            <form id="send" method="POST" action="excel1.php"  enctype="multipart/form-data">

           <div class="adm-form">

          <div class="item">
              <div class="level">Механические разрушения:</div>
              <div class="value">
          ...
          <div class="item">
              <div class="level">Номер акта:</div>
              <div class="value">
                <input type="text" style="    width: 20%;" name="act" />
              </div>
            </div>
   ...
   <div class="adm-finish">
           ...
           <br><hr>
           <form id="send2" method="POST" action="excel/script.php" enctype="multipart/form-data">

           <div class="adm-form">

          <div class="item">
              <div class="level">Диагностика и результаты:</div>
              <div class="value">
          ...
          <div class="item">
              <div class="level">Дата поступления:</div>
              <div class="value">
                <input type="text" id="datepicker" style="    width: 20%;" name="date" />
              </div>
            </div>
   ...
   <div class="adm-finish">
          ...
          <br><hr>
           <form id="send3" method="POST" action="excel1.php" enctype="multipart/form-data">

           <div class="adm-form">

          <div class="item">
              <div class="level">Нет АСЦ:</div>
              <div class="value">
                <input type="file" name="userfile" />
              </div>
            </div>
