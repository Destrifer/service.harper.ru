...
$sql = mysqli_query($db, 'SELECT '.$select.' FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' and `deleted` != 1 '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.' '.$where_target.' '.$where_type.' '.$where_impo_user.' '.$where_master_user.' '.$sWhere.' '.$sOrder.' '.$sLimit.';');
$sql_total = mysqli_fetch_array(mysqli_query($db, 'SELECT COUNT(*) FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' and `deleted` != 1 '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.' '.$where_target.' '.$where_type.' '.$where_impo_user.' '.$where_master_user.' '.$sWhere.' ;'));

} if (\models\User::hasRole('master', 'taker')) {


$sql = mysqli_query($db, 'SELECT '.$select.' FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].'  '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.'  '.$where_type.' '.$where_impo_user.' '.$where_master_user.' '.$sWhere.' '.$sOrder.' '.$sLimit.';');
$sql_total = mysqli_fetch_array(mysqli_query($db, 'SELECT COUNT(*) FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.'  '.$where_type.' '.$where_impo_user.' '.$where_master_user.' '.$sWhere.' ;'));
...
if ($_GET['get'] == 'deleted') {
$sql = mysqli_query($db, 'SELECT '.$select.' FROM `repairs`  WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' and `deleted` = 1 '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.' '.$where_type.' '.$where_impo_admin.' '.$where_master_user.' '.$sWhere.' '.$sOrder.' '.$sLimit.';');
$sql_total = mysqli_fetch_array(mysqli_query($db, 'SELECT COUNT(*) FROM `repairs`  WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' `deleted` = 1 '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.' '.$where_type.' '.$where_impo_admin.' '.$where_master_user.' '.$sWhere.' ;'));

} else {
$sql = mysqli_query($db, 'SELECT '.$select.' FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].'   '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.' '.$where_type.' '.$where_impo_admin.' '.$where_master_user.' '.$sWhere.' '.$sLimit.';');
$sql_total = mysqli_fetch_array(mysqli_query($db, 'SELECT COUNT(*) FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].'   '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.'  '.$where_type.' '.$where_impo_admin.' '.$where_master_user.' '.$sWhere.' ;'));

//echo 'SELECT COUNT(*) FROM `repairs` WHERE `serial` = \''.mysqli_real_escape_string($db, $_GET['serial']).'\' and `id` != '.$_GET['id'].' and   '.$where_date.' '.$where_date2.' '.$where_date3.' '.$where_date4.'  '.$where_type.' '.$where_impo_admin.' '.$where_master_user.' '.$sWhere.' ;';
...
$return = mysqli_fetch_array(mysqli_query($db, 'SELECT `name` FROM `returns` WHERE `id` = \''.mysqli_real_escape_string($db, $row['return_id']).'\''));
      ...
      $content_list[] = (($row['status_admin'] != 'Запрос на выезд' && $row['onway'] == 1) ? get_price_transfer($model['cat'], $row['onway_type']) : '0');
  ...
  $content_list[] = $client_info['name'];
    ...
    //$content_list[] = $row['rsc'];
      ...
      if ($row['status_admin'] != 'Подтвержден' && \models\User::hasRole('admin')) {
      ...
      if (!\models\User::hasRole('admin', 'taker') && $row['repair_done'] != 1) {
      ...
      if (\models\User::hasRole('slave-admin') && $row['status_admin'] != '') {
