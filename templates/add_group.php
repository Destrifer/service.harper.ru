...
mysqli_query($db, 'INSERT INTO `parts2_groups` (
`name`,
`code`
) VALUES (
\''.mysqli_real_escape_string($db, trim($_POST['name'])).'\',
\''.mysqli_real_escape_string($db, trim($_POST['code'])).'\'
);') or mysqli_error($db);
...
<head>
<meta charset=utf-8>
<title>Добавление группу - Панель управления</title>
