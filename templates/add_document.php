...
mysqli_query($db, 'INSERT INTO `documents` (
`name`
) VALUES (
...
admin_log_add('Добавлен новый документ '.$_POST['name']);

header('Location: '.$config['url'].'documents/'.$_GET['id'].'/');
}
...
<?=menu_dash();?>
  ...
  <form id="send" method="POST">
   <div class="adm-form" style="padding-top:0;">
              ...
              <div class="level" style="width: 300px;">Название документа:</div>
              <div class="value">
