...
\''.mysqli_real_escape_string($db, $_POST['block']).'\',
\''.mysqli_real_escape_string($db, $_POST['element']).'\',
\''.mysqli_real_escape_string($db, $_POST['acess']).'\',
\''.mysqli_real_escape_string($db, $_POST['anrp']).'\',
\''.mysqli_real_escape_string($db, $_POST['ato']).'\'
);') or mysqli_error($db);

admin_log_add('Добавлена новая цена');  
