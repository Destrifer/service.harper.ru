...
mysqli_query($db, 'INSERT INTO `repair_type_brand` (
`name`,
`brand_id`
) VALUES (
...
admin_log_add('Добавлен новый вид ремонта '.$_POST['name']);

header('Location: '.$config['url'].'repair-types-brand/'.$_GET['id'].'/');
}
