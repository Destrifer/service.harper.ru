...
mysqli_query($db, 'INSERT INTO `cityfull` (
`fcity_name`,
`fcity_country`
) VALUES (
\''.mysqli_real_escape_string($db, $_POST['fcity_name']).'\',
\''.mysqli_real_escape_string($db, $_POST['fcity_country']).'\'
);') or mysqli_error($db);

admin_log_add('Добавлен новый город '.$_POST['fcity_name']);
