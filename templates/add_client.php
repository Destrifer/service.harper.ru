...
\''.mysqli_real_escape_string($db, $_POST['scenario_id']).'\',
...
\''.mysqli_real_escape_string($db, $_POST['contact_name']).'\',
\''.mysqli_real_escape_string($db, $_POST['contacts_phone']).'\',
\''.mysqli_real_escape_string($db, $_POST['days']).'\'
);') or mysqli_error($db);

admin_log_add('Добавлен новый клиент '.$_POST['name']);
            ...
            <div class="item">
              ...
              <div class="value">
                <input type="text" name="contact_name" value="<?=$content['contact_name'];?>"  />
                  ...
                  <div class="item">
              <div class="level">Контактный эл. адрес:</div>
              <div class="value">
