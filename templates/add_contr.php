...
mysqli_query($db, 'INSERT INTO `contrahens` (
`name`,
`desc`
) VALUES (
...
admin_log_add('Добавлен новый контрагент '.$_POST['name']);

header('Location: '.$config['url'].'contrahens/');
}
...
<?=menu_dash();?>
  ...
  <form id="send" method="POST">
   <div class="adm-form" style="padding-top:0;">
                        ...
                        <div class="item">
              <div class="level">Название контрагента:</div>
              <div class="value">
                <input type="text" name="name" style="width:400px;" value="<?=$content['name'];?>"  />
                        ...
                        <div class="item">
              <div class="level">Название руководящей должности:</div>
              <div class="value">
                <input type="text" name="desc" style="width:400px;" value="<?=$content['desc'];?>"  />
              </div>
            </div>
