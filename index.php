...
if ($_GET['query'] == 'get-payment-act-optima-pppo') {
 ...
 // if (User::hasRole('admin')) {
  require_once 'adm/excel/vendor/autoload.php';
        ...
        $sheet->setCellValue('B14', 'ДС №3 к договору сервисного обслуживания №30/04/2018 от 30.04.2018');
...
if ($_GET['query'] == 'get-payment-bill-optima-pppo') {
 ...
 // if (User::hasRole('admin')) {
  require_once 'adm/excel/vendor/autoload.php';
        ...
        $sheet->setCellValue('B17', 'ДС №3 к договору сервисного обслуживания №30/04/2018 от 30.04.2018');
...
while ($row = mysqli_fetch_array($sql)) {
      ...
      } else if ($content['model']['brand'] != 'TESLER' && $content['model']['brand'] != 'NESONS' && $content['model']['brand'] != 'HARPER' && $content['model']['brand'] != 'OLTO' && $content['model']['brand'] != 'HORIZONT') {
